# This is the original implementation of the networks described in the MVPCC paper
# git: https://github.com/sztaki-geocomp/Multi-view-3d-completion/blob/main/src/networks.py
    ...
    def init_weights(self, init_type='normal', gain=0.02):
        ...
        def init_func(m):
            ...
            if hasattr(m, 'weight') and (classname.find('Conv') != -1 or classname.find('Linear') != -1):
                ...
                elif init_type == 'kaiming_discriminator':
...
class InpaintGenerator(BaseNetwork):
    def __init__(self, n_views=4, residual_blocks=8, init_weights=True):
...
class Discriminator(BaseNetwork):
    ...
    def forward(self, x):
        ...
        return outputs , [conv2, conv3, conv4, conv5] 
